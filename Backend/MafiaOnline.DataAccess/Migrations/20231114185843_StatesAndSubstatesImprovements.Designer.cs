...
namespace MafiaOnline.DataAccess.Migrations
{
    ...
    [Migration("20231114185843_StatesAndSubstatesImprovements")]
    partial class StatesAndSubstatesImprovements
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MafiaOnline.DataAccess.Entities.MapElement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            BossId = 1L,
                            Description = "Headquarters of Patricio Rico",
                            Hidden = false,
                            Type = 1,
                            X = 2L,
                            Y = 1L
                        ...
                        new
                        {
                            Id = 2L,
                            BossId = 2L,
                            Description = "Headquarters of Rodrigo Margherita",
                            Hidden = false,
                            Type = 1,
                            X = 14L,
                            Y = 1L
                        ...
                        {
                            Id = 4L,
                            Description = "Mission: Senator assassination",
                            Hidden = false,
                            Type = 2,
                            X = 3L,
                            Y = 5L
                        ...
                        {
                            Id = 6L,
                            Description = "Mission: Buy a coffee",
                            Hidden = false,
                            Type = 2,
                            X = 5L,
                            Y = 3L
                        ...
                        {
                            Id = 7L,
                            Description = "Mission: Money laundering",
                            Hidden = false,
                            Type = 2,
                            X = 14L,
                            Y = 1L
                        ...
                        {
                            Id = 9L,
                            Description = "Mission: Arms trade",
                            Hidden = false,
                            Type = 2,
                            X = 14L,
                            Y = 5L
            ...
            modelBuilder.Entity("MafiaOnline.DataAccess.Entities.News", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MafiaOnline.DataAccess.Entities.State", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MafiaOnline.DataAccess.Entities.Substate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("Substate", (string)null);

                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Name = "MovingOnMission",
                            StateId = 5L
                        },
                        new
                        {
            ...
            modelBuilder.Entity("MafiaOnline.DataAccess.Entities.VBossWithPosition", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "340a24cf-4d75-4cfe-acf9-f3aac620fc9c",
                            Name = "Administrator",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b35a8440-8a82-472f-af19-b0d4297f28d1",
                            Name = "Player",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            UserId = "8e445865-a24d-4543-1234-9443d048cdb9",
                            RoleId = "2c5e174e-3b0e-446f-86af-483d56fd7210"
                        });
                });
            ...
            modelBuilder.Entity("MafiaOnline.DataAccess.Entities.Player", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "eac392b4-0be9-40a4-8894-c0cfa393b4c4",
                            Email = "mafiaonlineteam@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "MAFIAONLINETEAM@GMAIL.COM",
                            NormalizedUserName = "MAFIA",
                            PasswordHash = "AQAAAAEAACcQAAAAEA5uBw9OICPohpwkyXosEuLDLIY3IPwftbwvIs6rZssbAgzIvtoMCXEPJ24WboPPNw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "239c464e-9a36-4140-af70-d1576faf1e03",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "683ed198-e5ea-4dd4-99cf-fcfce5dab672",
                            Email = "mafiaonlineteam2@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "MAFIAONLINETEAM2@GMAIL.COM",
                            NormalizedUserName = "TOMEK",
                            PasswordHash = "AQAAAAEAACcQAAAAEIs+TS4UWUHE8o1w9hoKHNr8mCPJeR01EjMpdGVEb9n04LxXhRPaAo78MY4JigGQag==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "c8669b52-83e5-4e6b-92f9-4cda0abd2be8",
                            TwoFactorEnabled = false,
                            UserName = "tomek",
                            BossId = 2L,
                            RefreshTokenExpiryTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
            ...
            modelBuilder.Entity("MafiaOnline.DataAccess.Entities.Agent", b =>
                {
                    ...
                    b.HasOne("MafiaOnline.DataAccess.Entities.State", "State")
                        .WithMany()
                        .HasForeignKey("StateId");

                    b.HasOne("MafiaOnline.DataAccess.Entities.Substate", "Substate")
                        .WithMany()
            ...
            modelBuilder.Entity("MafiaOnline.DataAccess.Entities.Player", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", null)
                        .WithOne()
                        .HasForeignKey("MafiaOnline.DataAccess.Entities.Player", "Id")
